...
__all__ = ["default_corpus", "calibration", "heuristic_arbiter"]
from . import calibration, heuristic_arbiter  # noqa: E402,F401  (phase 7: `testing.calibration` is an attribute in a fresh process)
